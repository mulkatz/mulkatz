...
- 🛸 **[mulder](https://github.com/mulkatz/mulder)** — Config-driven Document Intelligence Platform. PDFs → Knowledge Graph, defined by one YAML, deployed on GCP. [Demo](https://mulder.mulkatz.dev)
