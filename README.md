...
- 🇩🇪 **[deutsche-feiertage](https://github.com/mulkatz/deutsche-feiertage)** — German public holidays for all 16 states with Brückentage calculator. TypeScript, zero deps, <1KB
- 📊 **[tiny-sparkline](https://github.com/mulkatz/tiny-sparkline)** — Tiny SVG sparkline for React. Line, area, bar, dot variants. Tooltips, animations, <2KB
- 🌀 **[scroll-velocity](https://github.com/mulkatz/scroll-velocity)** — React hook & components for scroll-speed animations. Text skew, velocity marquee, opacity. <1.5KB
